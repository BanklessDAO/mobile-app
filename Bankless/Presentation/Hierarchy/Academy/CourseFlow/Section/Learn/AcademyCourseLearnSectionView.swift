...
class AcademyCourseLearnSectionView: BaseView<AcademyCourseLearnSectionViewModel>,
                                     AcademyCourseSectionView
{
    ...
    private func setUpConstraints() {
        ...
        constrain(markupView, separatorView, self) { markup, sep, view in
            markup.left == view.left
            markup.right == view.right
            markup.top == sep.bottom + contentInsets.bottom * 2
