...
class NewsItemListCell: BaseTableViewCell<NewsItemViewModel> {
    class var reuseIdentifier: String {
        return String(describing: NewsItemListCell.self)
    }
    ...
    override func setUpConstraints() {
        constrain(newsItemView, contentView) { (item, view) in
    ...
    override func bindViewModel() {
        newsItemView.set(viewModel: viewModel)
        newsItemView.bindViewModel()
    }
}
